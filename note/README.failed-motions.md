...
**Path:** `/home/hlz/datasets/humos_proto/failed_clips.pt`  
**Size:** 10.9 GB  
**Motions:** 24,576 = 192 clips × 128 betas  

The 192 clips are those with avg_betas_failed_per_epoch ≥ 5.0 across epochs 8000–12000 (the "broader hard-clip curriculum"). This is a looser threshold than the 65 clips at ≥8.0 ("truly broken").

| Threshold | # clips | # motions | File size |
|---|---|---|---|
| ≥ 5.0 avg betas/epoch | 192 | 24,576 | 10.9 GB |
| ≥ 8.0 avg betas/epoch | 65 | 8,320 | ~3.4 GB |

Generated by `tools/extract_failed_motions.py` (or equivalent interactive script). To regenerate the 65-clip version:
```bash
