...
fidelity cost, but no causal learning benefit from refined training is
claimed: the refined and unrefined runs track different targets and were not
cross-evaluated on a common reference.
