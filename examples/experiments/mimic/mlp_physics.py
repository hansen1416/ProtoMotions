...
#
"""
Mimic + Physics Features Experiment
====================================

Identical to mlp.py, but replaces the raw-betas morphology_obs (11-dim) with
z-scored physics features extracted from SMPL XMLs (15-dim):
  total_mass, limb lengths, torso/head height, hip/shoulder width,
  leg_length, total_height.

Requires: tools/extract_smpl_physics_features.py to have been run, producing
  protomotions/data/assets/mjcf/smpl_mor/physics_features.pt

Training run name: hhi_physics_feat_1024
"""
...
_MAIN_OBS_KEYS = ["max_coords_obs", "mimic_target_poses", "previous_actions", "physics_obs"]
