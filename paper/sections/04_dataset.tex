...
These splits test held-out clip identities on the trained body set. They are
not demonstrated to be disjoint by subject or original capture recording --
different segments can still share a source recording -- which limits claims
about broader motion generalization.
