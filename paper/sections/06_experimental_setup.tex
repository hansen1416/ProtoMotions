...
\pending{Break the full-scale GPU-hours out by pre- and post-restart segment
if the launcher logs are recovered. No superior compute-efficiency claim is
made from the current evidence -- the temporal MLP's lower wall-clock cost is
not weighed against its higher position error relative to slot/type in
