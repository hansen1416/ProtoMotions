...
\begin{figure}[t]
  ...
  \begin{tabular}{c@{\;}c@{\;}c@{\;}c@{\;}c@{\;}c@{\;}c}
    \fbox{\parbox{0.17\linewidth}{\centering Canonical AMASS\\150 clips $\times$ 128 shapes\\DOF/rotation target}}
    & $+$ &
    \fbox{\parbox{0.17\linewidth}{\centering HUMOS\\150 clips $\times$ 128 shapes\\world-space target}}
    & $\longrightarrow$ &
    \fbox{\parbox{0.22\linewidth}{\centering Source-conditioned reward\\AMASS: 75/25\\HUMOS: 30/70}}
    & $\longrightarrow$ &
    \fbox{\parbox{0.15\linewidth}{\centering One shared\\morphology-conditioned policy}}
  \end{tabular}
  \caption{Current source-weighted training pipeline. AMASS/HUMOS episodes are sampled 50/50;
  both receive all tracking factors with source-specific DOF/world weights.}
  \label{fig:source-weighted-pipeline}
\end{figure}
