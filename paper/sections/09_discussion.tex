...
evaluation horizon. Fixed-pair test evaluation and unseen-body experiments
...
training. They also limited repeated seeds and introduced memory-related
resumes and configuration changes. These costs and changes should be
reported transparently; they do not by themselves establish better
compute efficiency than another method.
